<template>
  <div class="demo">
    <el-button type="primary" @click="btn">工厂模型单选</el-button>
    <div class="mobile" v-show="dialogVisible">
      <div class="mask-layer" @click="cancel"></div>
      <div class="mobile-content">
        <div class="other-not">
          <factory-model-radio :dialogVisible="dialogVisible" :title="'工厂模型单选'" :companyName="'文谷亦云'"
            :list="factoryModelList" :selectedList="selectedList" :notOptionalList="[]" :notOptionalType="[1, 2]"
            :notShowingType="[]" @confirm="sureConfirm" @cancel="sureCancel"></factory-model-radio>
...
<script>
import factoryModelRadio from "./Main.vue";
export default {
  name: "index",
  components: { factoryModelRadio },
  data() {
    return {
      dialogVisible: false,
      factoryModelList: [
